...
from utils.io_op import read, write
...
class Track():
    def __init__(self, samplerate: int, data: NDArray, trackpath:Path|None = None):
        """
        :param samplerate: the sampling rate of the track
